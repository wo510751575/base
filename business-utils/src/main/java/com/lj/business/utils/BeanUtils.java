...
public class BeanUtils extends BeanUtilsBean {
	...
	static{
		beanUtils.getConvertUtils().register(new DateConver(), java.util.Date.class);
		beanUtils.getConvertUtils().register(new DateConver(), java.sql.Date.class);
	}
	 ...
	 * @throws InvocationTargetException
	 */
	public static void copyPropertiesNull(Object dest, Object orig, boolean ignoreNullFlag) throws IllegalAccessException, InvocationTargetException{
		beanUtils.copyProperties(dest, orig, ignoreNullFlag);
	}
